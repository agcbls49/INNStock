...
// have to fucking add this for redirect after changing password to sign out user
...
function ChangePasswordForm({
  ...
  // variable to use for redirect given by next js
  ...
  const { mutateAsync: changePassword, isPending } = useChangePassword(
    authClient,
    {
      ...
      onSuccess: async() => {
        ...
        // sign out the user then redirect them to login page
  ...
  return (
    <div>
      <h2 className="text-md font-semibold mb-3 capitalize">
        {localization.settings.changePassword}
      </h2>
